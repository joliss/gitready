...
p=. This is a guest post from "Jo Liss":http://opinionated-programmer.com/.

I picked up this neat trick to use Git as a kind of feed-reader on "Moro's blog":http://d.hatena.ne.jp/moro/20110719/1311048331, so I thought I'd share it here:
...
p(. <i>Jo Liss blogs at "Opinionated Programmer":http://opinionated-programmer.com/ and makes voting software at "Electic":http://electic-voting.com/. </i>
